...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lua-mode typescript-mode csharp-mode glsl-mode ligature highlight-indentation r lsp-ivy lsp-treemacs fsharp-mode all-the-icons solaire-mode doom-themes treemacs-projectile treemacs haskell-mode terraform-mode rustic flycheck lsp-ui lsp-mode ivy-rich rich-ivy rainbow-delimiters which-ley projectile mood-line company use-package counsel))
 '(safe-local-variable-values
   '((projectile-project-compilation-cmd . fsharp-compile-project)
     (projectile-project-test-cmd . fsharp-test-project))))
(custom-set-faces
