...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ivy lsp-treemacs fsharp-mode all-the-icons solaire-mode doom-themes treemacs-projectile treemacs haskell-mode terraform-mode rustic flycheck lsp-ui lsp-mode ivy-rich rich-ivy rainbow-delimiters which-ley projectile mood-line company use-package counsel)))
(custom-set-faces
